...
class GetSinksResult:
    ...
    """
    def __init__(__self__, database_name=None, id=None, schema_name=None, sinks=None):
    ...
    @property
    @pulumi.getter
    def sinks(self) -> Sequence['outputs.GetSinksSinkResult']:
        """
...
def get_sinks(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('materialize:index/getSinks:GetSinks', __args__, opts=opts, typ=GetSinksResult).value
...
def get_sinks_output(database_name: Optional[pulumi.Input[Optional[str]]] = None,
                     schema_name: Optional[pulumi.Input[Optional[str]]] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSinksResult]:
    """
    ## Example Usage
