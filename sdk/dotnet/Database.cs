...
namespace Pulumi.Materialize
{
    ...
    /// ```
    /// </summary>
    [MaterializeResourceType("materialize:index/database:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs? args = null, CustomResourceOptions? options = null)
            : base("materialize:index/database:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, DatabaseState? state = null, CustomResourceOptions? options = null)
            : base("materialize:index/database:Database", name, state, MakeResourceOptions(options, id))
        {
        }
