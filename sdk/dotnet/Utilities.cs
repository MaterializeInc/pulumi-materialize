...
namespace Pulumi.Materialize
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/MaterializeInc/pulumi-materialize";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Materialize.version.txt");
    ...
    internal sealed class MaterializeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public MaterializeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
