...
//				return err
//			}
//			_, err = materialize.GetSchemas(ctx, &GetSchemasArgs{
...
func GetSchemas(ctx *pulumi.Context, args *GetSchemasArgs, opts ...pulumi.InvokeOption) (*GetSchemasResult, error) {
	...
	err := ctx.Invoke("materialize:index/getSchemas:GetSchemas", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Limit schemas to a specific database
func (o GetSchemasResultOutput) DatabaseName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetSchemasResult) *string { return v.DatabaseName }).(pulumi.StringPtrOutput)
}
