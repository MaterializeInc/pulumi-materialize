...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `materialize` with the `NAME` of your provider.
...
- binary: pulumi-resource-materialize
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-materialize/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-materialize_darwin_amd64_v1
│   └── pulumi-resource-materialize
├── pulumi-materialize_darwin_arm64
│   └── pulumi-resource-materialize
├── pulumi-materialize_linux_amd64_v1
│   └── pulumi-resource-materialize
├── pulumi-materialize_linux_arm64
│   └── pulumi-resource-materialize
├── pulumi-materialize_windows_amd64_v1
│   └── pulumi-resource-materialize.exe
└── pulumi-materialize_windows_arm64
    └── pulumi-resource-materialize.exe
```
