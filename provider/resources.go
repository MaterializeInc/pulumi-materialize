...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"materialize_connection_sqlserver":                 {Tok: tfbridge.MakeResource(mainPkg, mainMod, "ConnectionSqlserver")},
			...
			"materialize_network_policy":                       {Tok: tfbridge.MakeResource(mainPkg, mainMod, "NetworkPolicy")},
			"materialize_region":                               {Tok: tfbridge.MakeResource(mainPkg, mainMod, "CloudRegion")},
			...
			"materialize_scim_group":                           {Tok: tfbridge.MakeResource(mainPkg, mainMod, "SCIM2Group")},
			"materialize_scim_group_roles":                     {Tok: tfbridge.MakeResource(mainPkg, mainMod, "SCIM2GroupRoles")},
			"materialize_scim_group_users":                     {Tok: tfbridge.MakeResource(mainPkg, mainMod, "SCIM2GroupUsers")},
			...
			"materialize_source_sqlserver":                     {Tok: tfbridge.MakeResource(mainPkg, mainMod, "SourceSqlserver")},
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"materialize_network_policy":    {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "GetNetworkPolicies")},
