...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"materialize_grant_cluster":                        {Tok: tfbridge.MakeResource(mainPkg, mainMod, "GrantCluster")},
			"materialize_grant_connection":                     {Tok: tfbridge.MakeResource(mainPkg, mainMod, "GrantConnection")},
			"materialize_grant_database":                       {Tok: tfbridge.MakeResource(mainPkg, mainMod, "GrantDatabase")},
			"materialize_grant_materialized_view":              {Tok: tfbridge.MakeResource(mainPkg, mainMod, "GrantMaterializedView")},
			"materialize_grant_schema":                         {Tok: tfbridge.MakeResource(mainPkg, mainMod, "GrantSchema")},
			"materialize_grant_secret":                         {Tok: tfbridge.MakeResource(mainPkg, mainMod, "GrantSecret")},
			"materialize_grant_source":                         {Tok: tfbridge.MakeResource(mainPkg, mainMod, "GrantSource")},
			"materialize_grant_table":                          {Tok: tfbridge.MakeResource(mainPkg, mainMod, "GrantTable")},
			"materialize_grant_type":                           {Tok: tfbridge.MakeResource(mainPkg, mainMod, "GrantType")},
			"materialize_grant_view":                           {Tok: tfbridge.MakeResource(mainPkg, mainMod, "GrantView")},
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"materialize_types":             {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "GetTypes")},
